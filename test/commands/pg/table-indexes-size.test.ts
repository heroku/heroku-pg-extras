...
import PgTableIndexesSize from '../../../src/commands/pg/table-indexes-size'
...
describe('pg:table-indexes-size', function () {
  ...
  context('when the --app flag is specified', function () {
    context('when table indexes size query executes successfully', function () {
      it('shows table indexes size information', async function () {
    ...
    context('when database argument is specified', function () {
      it('executes query against specified database', async function () {
        ...
        try {
          await runCommand(PgTableIndexesSize, ['--app=my-app', 'custom-db'])
